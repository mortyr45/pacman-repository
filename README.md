...
| gitbutler-bin                   | [Archlinux AUR](https://aur.archlinux.org/packages/gitbutler-bin)                   | Version control client, backed by Git, powered by Tauri/Rust/Svelte.                                                        |
| gitbutler-cli-bin               | [Archlinux AUR](https://aur.archlinux.org/packages/gitbutler-cli-bin)               | Git client with things like parallel and stacked branches, just the CLI.                                                     |
